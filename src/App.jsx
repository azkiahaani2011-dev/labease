  ...
  return (
    <div style={{ minHeight:"100vh", background:"#F5F7FA", fontFamily:"'Manrope',sans-serif" }}>
      ...
      <div style={{ background:"#fff", borderBottom:"1px solid var(--line)", padding:"20px 0" }}>
        <div style={{ ...T.wrap }}>
          <div style={{ display:"flex" }}><button onClick={()=>navTo("home")} style={{ background:"transparent",border:"none",color:"#1158A6",fontWeight:700,cursor:"pointer",fontSize:".84rem",fontFamily:"'Manrope',sans-serif",padding:"8px 0",marginBottom:16,display:"inline-flex",alignItems:"center",gap:6,borderRadius:50 }}>
  ...
  <div style={{ minHeight:"80vh" }}>
    ...
    <div style={{ background:"#fff",borderBottom:"1px solid var(--line)",position:"sticky",top:64,zIndex:50 }}>
      <div style={{ ...T.wrap,padding:"18px 12px" }}>
        <div style={{ display:"flex" }}><button onClick={()=>navTo("labs")} style={{ background:"transparent",border:"none",color:"#1158A6",fontWeight:700,cursor:"pointer",fontSize:".84rem",fontFamily:"'Manrope',sans-serif",padding:"8px 0",marginBottom:12,display:"inline-flex",alignItems:"center",gap:6,borderRadius:50 }}><svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M13 8H3M7 4l-4 4 4 4"/></svg>All Labs</button></div>
      ...
      <div style={{ background:"#fff", borderBottom:"1px solid #E5E7EB", padding:"14px 0" }}>
        <div style={{ maxWidth:1600, margin:"0 auto", padding:"0 24px", textAlign:"left" }}>
          <button onClick={()=>navTo("home")}
            style={{ background:"transparent",border:"none",color:"#1158A6",fontWeight:700,cursor:"pointer",fontSize:".84rem",fontFamily:"'Manrope',sans-serif",padding:"8px 0",marginBottom:6,display:"inline-flex",alignItems:"center",gap:6,borderRadius:50 }}>
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M13 8H3M7 4l-4 4 4 4"/></svg>
            Back to Home
          </button>
    ...
    return (
      <div style={{ minHeight:"80vh",background:"#F8FAFC",fontFamily:"'Manrope',sans-serif",padding:"32px 16px" }}>
        <div style={{ maxWidth:560,margin:"0 auto" }}>
          {/* Back */}
          <button onClick={()=>navTo("home")} style={{ background:"transparent",border:"none",color:"#1158A6",fontWeight:700,cursor:"pointer",fontSize:".84rem",fontFamily:"'Manrope',sans-serif",padding:"8px 0",marginBottom:24,display:"inline-flex",alignItems:"center",gap:6,borderRadius:50 }}>
            ← Back to Home
          </button>
