  ...
  return (
    <div style={{ position:"relative", marginBottom:10 }}>
      ...
      <div style={{ position:"absolute", bottom:16, left:0, right:0, display:"flex", justifyContent:"center", alignItems:"center", gap:6, zIndex:10 }}>
        {[0,1].map(i=>(
          <button key={i} onClick={()=>goTo(i)} style={{ width:i===idx?20:8,height:8,borderRadius:50,background:i===idx?"#1158A6":"rgba(17,88,166,.25)",border:"none",cursor:"pointer",padding:0,transition:"all .3s" }}/>
        ))}
      </div>
    </div>
  );
      ...
      <div style={{ display:"grid", gridTemplateColumns: mob ? "1fr 1fr" : "1fr 1fr 1fr", gap: mob ? "14px 18px" : "14px 48px", width:"100%", zIndex:1 }}>
        {[
          ...
          <div key={i} style={{ display:"flex", alignItems:"center", gap: mob ? 10 : 14 }}>
            <div style={{ width: mob ? 40 : 46, height: mob ? 40 : 46, borderRadius:"50%", border:"2px solid rgba(134,239,172,.6)", background:"rgba(134,239,172,.08)", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, boxShadow:"0 0 0 1px rgba(134,239,172,.15)" }}>
              <Ic/>
            </div>
            <div>
              <div style={{ fontSize: mob ? ".68rem" : ".74rem", color:"rgba(255,255,255,.6)", lineHeight:1.3, marginBottom:2 }}>{t1}</div>
              <div style={{ fontSize: mob ? ".78rem" : ".86rem", fontWeight:700, color:"#fff", lineHeight:1.3 }}>{t2}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{ maxWidth:1100, margin:"0 auto", padding: mob ? "0 12px" : "0 24px" }}>
        <div style={{ height: mob ? "auto" : 280, position:"relative" }}>
          ...
          <div style={{ position:"absolute", bottom:14, left:0, right:0, display:"flex", justifyContent:"center", alignItems:"center", gap:6, zIndex:10 }}>
            {[0,1].map(i => (
              <button key={i} onClick={()=>setSlide(i)} style={{ width:i===slide?20:8, height:8, borderRadius:50, background:i===slide?"#fff":"rgba(255,255,255,.4)", border:"none", cursor:"pointer", padding:0, transition:"all .3s" }}/>
            ))}
          </div>
        </div>
      </div>
