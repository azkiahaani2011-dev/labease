...
const LAB_META = [
  ...
  { id:6, short:"Vijaya",     accent:"#0369A1", bg:"#F0F9FF", city:"Hyderabad", tag:"Radiology Expert",   since:"Est. 1981",
              ...
              <div key={l.id} style={{ background:"#fff",borderRadius:0,borderBottom:"1px solid #E5E7EB",overflow:"hidden",fontFamily:"'Manrope',sans-serif" }}>
                <div style={{ padding:"20px 18px 18px" }}>
                  ...
                  <div style={{ display:"flex",gap:14,alignItems:"flex-start",marginBottom:16 }}>
                    ...
                    <div style={{ flex:1,minWidth:0 }}>
                      <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:6 }}>
                        <span style={{ fontWeight:900,fontSize:"1.08rem",color:"#0D1117",lineHeight:1.3,letterSpacing:"-.02em" }}>{l.name}</span>
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" style={{ flexShrink:0,marginTop:1 }}>
                          ...
                          <polyline points="8 12 11 15 16 9" stroke="#9CA3AF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
                      <div style={{ fontSize:".82rem",color:"#6B7280",marginBottom:5,marginTop:1 }}>Diagnostic Lab</div>
                      <div style={{ display:"flex",alignItems:"center",gap:5,fontSize:".83rem",fontWeight:700,color:"#16A34A" }}>
                  ...
                  <div style={{ display:"flex",gap:10 }}>
                    ...
                    {/* Right column: home collection → Book Now */}
                    <div style={{ flex:1,display:"flex",flexDirection:"column",gap:6 }}>
                      <div style={{ display:"flex",alignItems:"center",gap:5,fontSize:".8rem",color:"#374151",fontWeight:500 }}>
  ...
  <div style={{ minHeight:"80vh" }}>
    ...
    <div style={{ background:"#fff",borderBottom:"1px solid var(--line)",position:"sticky",top:64,zIndex:50 }}>
      <div style={{ ...T.wrap,padding:"18px 12px" }}>
        <button onClick={()=>navTo("labs")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:12,transition:"all .18s" }} aria-label="Back">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
        </button>
    ...
    <div style={{ minHeight:"100vh", background:"#F5F7FF", fontFamily:"'Manrope',sans-serif" }}>
      <div style={{ background:"#fff", borderBottom:"1px solid #E5E7EB", padding:"14px 0" }}>
        <div style={{ maxWidth:1600, margin:"0 auto", padding:"0 24px", textAlign:"left" }}>
          <button onClick={()=>navTo("home")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:6,transition:"all .18s" }} aria-label="Back">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
          </button>
  ...
  return (
    <div>
      ...
      <div style={{ display:"flex",gap:10,marginTop:4 }}>
        <button onClick={onBack} style={{ width:44,height:44,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .18s" }} aria-label="Back"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg></button>
  ...
  return (
    <div style={{ padding:"40px 0 52px",minHeight:"100vh",background:"#F5F7FF",fontFamily:"'Manrope',sans-serif" }}>
      <div style={{ maxWidth:680,margin:"0 auto",padding:"0 20px" }}>
        ...
        <button onClick={()=>navTo("lab")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:20,transition:"all .18s" }} aria-label="Back">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
        </button>
        ...
        <div style={{ background:"#fff",borderRadius:18,padding:"28px 28px",border:"1.5px solid #EEF2FF",boxShadow:"0 4px 20px rgba(17,88,166,.07)" }}>
          ...
          {step===2&&(
            <div style={{ animation:"slideUp .28s" }}>
              ...
              <div style={{ display:"flex",gap:10,marginTop:22 }}>
                <button onClick={()=>setStep(1)} style={{ width:44,height:44,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .18s" }} aria-label="Back"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg></button>
          ...
          {step===3&&(
            <div style={{ animation:"slideUp .28s" }}>
              ...
              <div style={{ display:"flex",gap:10,marginTop:6 }}>
                <button onClick={()=>setStep(2)} style={{ width:44,height:44,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .18s" }} aria-label="Back"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg></button>
          ...
          {step===4&&(
            <div style={{ animation:"slideUp .28s" }}>
              ...
              <div style={{ display:"flex",gap:10 }}>
                <button onClick={()=>setStep(3)} style={{ width:44,height:44,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all .18s" }} aria-label="Back"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg></button>
...
export default function App() {
      ...
      <section style={{ padding:"18px 0",background:"#fff" }}>
        <div style={{ ...T.wrap,maxWidth:780 }}>
          ...
          <div style={{ display:"grid",gap:8 }}>
            {FAQS.map((item,i)=>(
              <div key={i} style={{ background:"#F5F7FF",borderRadius:14,border:"1px solid #EEF2FF",overflow:"hidden",transition:"all .18s" }}>
    ...
    <div style={{ minHeight:"100vh",background:"#F5F7FF",fontFamily:"'Manrope',sans-serif" }}>
      <div style={{ background:"#fff",borderBottom:"1px solid #E5E7EB",padding:"20px 0" }}>
        <div style={{ maxWidth:760,margin:"0 auto",padding:"0 20px" }}>
          <button onClick={()=>navTo("home")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:16,transition:"all .18s" }} aria-label="Back">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
          </button>
    ...
    return (
      <div style={{ minHeight:"80vh",background:"#F5F7FF",fontFamily:"'Manrope',sans-serif",padding:"32px 16px" }}>
        <div style={{ maxWidth:560,margin:"0 auto" }}>
          {/* Back */}
          <button onClick={()=>navTo("home")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:24,transition:"all .18s" }} aria-label="Back">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
          </button>
            ...
            {cart.length===0 ? (
              ...
              <div style={{ padding:"20px 24px 28px" }}>
                ...
                <div style={{ paddingTop:16,borderTop:"2px dashed #E5E7EB",marginTop:4 }}>
                  ...
                  <div style={{ display:"flex",justifyContent:"space-between",color:"#1158A6",fontSize:".83rem",marginBottom:10,fontWeight:700 }}>
                    <span>You Save</span><span>−₹{saving.toLocaleString()}</span>
                  </div>
                ...
                return (
                  <div key={item.tid} style={{ marginBottom:14,borderRadius:14,border:"1px solid #E5E7EB",overflow:"hidden" }}>
                    ...
                    <div style={{ padding:"12px 16px" }}>
                      <span style={{ background:"#EFF6FF",color:"#1D4ED8",borderRadius:20,padding:"3px 11px",fontSize:".72rem",fontWeight:600,display:"inline-block",marginBottom:10 }}>{sampleIcon} Sample: {prep.sample}</span>
      ...
      <div style={{ background:"#fff",maxWidth:520,width:"100%",padding:"40px 36px",textAlign:"center",animation:"scaleIn .35s cubic-bezier(.34,1.56,.64,1)",borderRadius:24,border:"1.5px solid #EEF2FF",boxShadow:"0 8px 40px rgba(17,88,166,.1)" }}>
        ...
        <div style={{ display:"flex",gap:10 }}>
          <button onClick={()=>{ navTo("labs"); setDone(null); }}
            style={{ flex:1,background:"#F5F7FF",color:"#1158A6",border:"1.5px solid #DBEAFE",borderRadius:50,padding:"12px",fontWeight:700,fontSize:".86rem",cursor:"pointer",fontFamily:"'Manrope',sans-serif",transition:"all .14s" }}
    ...
    return (
      <div style={{ minHeight:"100vh",background:"#F5F7FF",fontFamily:"'Manrope',sans-serif" }}>
        ...
        <div style={{ background:"#fff",borderBottom:"1px solid var(--line)",padding:"20px 0" }}>
          <div style={{ ...T.wrap }}>
            <button onClick={()=>navTo("home")} style={{ width:40,height:40,borderRadius:"50%",border:"none",background:"#2A2A2A",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:14,transition:"all .18s" }} aria-label="Back">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
            </button>
  ...
  return (
    <div style={{ fontFamily:"'Manrope',sans-serif",minHeight:"100vh",background:"#F5F7FF" }}>
      ...
      {/* ── Sticky trust bar ── */}
      <div style={{ position:"fixed",top:64,left:0,right:0,zIndex:199,background:"linear-gradient(90deg,#0C1F4A 0%,#163268 50%,#0C1F4A 100%)",height:36,display:"flex",alignItems:"center",justifyContent:"center" }}>
                        ...
                        {cart.map(item=>{
                          ...
                          return (
                            <div key={item.tid} style={{ borderRadius:9,overflow:"hidden",border:"1px solid #E5E7EB" }}>
                              <div style={{ background:"#F5F7FF",padding:"8px 12px",borderBottom:"1px solid #E5E7EB",display:"flex",alignItems:"center",justifyContent:"space-between" }}>
          ...
          <div onClick={e=>e.stopPropagation()} style={{ background:"#fff",borderRadius:24,width:"100%",maxWidth:420,fontFamily:"'Manrope',sans-serif",boxShadow:"0 32px 80px rgba(0,0,0,.28)",animation:"scaleIn .22s cubic-bezier(.34,1.56,.64,1)",overflow:"hidden" }}>
            ...
            <div style={{ padding:"24px 28px 28px" }}>
              {authMode==="signup" && (
                <>
                  <div style={{ marginBottom:14 }}>
                    ...
                    <input value={authForm.name} onChange={e=>setAuthForm(f=>({...f,name:e.target.value}))} placeholder="Priya Sharma" style={{ width:"100%",border:"1.5px solid #E5E7EB",borderRadius:10,padding:"11px 14px",fontSize:".9rem",fontFamily:"'Manrope',sans-serif",background:"#F5F7FF",color:"#111",display:"block",boxSizing:"border-box" }}/>
                  </div>
                  <div style={{ marginBottom:14 }}>
                    <label style={{ display:"block",fontWeight:700,fontSize:".78rem",color:"#374151",marginBottom:6 }}>Phone Number</label>
                    <input value={authForm.phone} onChange={e=>setAuthForm(f=>({...f,phone:e.target.value}))} placeholder="+91 98765 43210" style={{ width:"100%",border:"1.5px solid #E5E7EB",borderRadius:10,padding:"11px 14px",fontSize:".9rem",fontFamily:"'Manrope',sans-serif",background:"#F5F7FF",color:"#111",display:"block",boxSizing:"border-box" }}/>
                  </div>
                </>
              )}
              <div style={{ marginBottom:14 }}>
                <label style={{ display:"block",fontWeight:700,fontSize:".78rem",color:"#374151",marginBottom:6 }}>Email Address</label>
                <input type="email" value={authForm.email} onChange={e=>setAuthForm(f=>({...f,email:e.target.value}))} placeholder="you@example.com" style={{ width:"100%",border:"1.5px solid #E5E7EB",borderRadius:10,padding:"11px 14px",fontSize:".9rem",fontFamily:"'Manrope',sans-serif",background:"#F5F7FF",color:"#111",display:"block",boxSizing:"border-box" }}/>
              </div>
              <div style={{ marginBottom:authErr?10:20 }}>
                ...
                <input type="password" value={authForm.password} onChange={e=>setAuthForm(f=>({...f,password:e.target.value}))} onKeyDown={e=>e.key==="Enter"&&handleAuth()} placeholder="Min 6 characters" style={{ width:"100%",border:"1.5px solid #E5E7EB",borderRadius:10,padding:"11px 14px",fontSize:".9rem",fontFamily:"'Manrope',sans-serif",background:"#F5F7FF",color:"#111",display:"block",boxSizing:"border-box" }}/>
              </div>
