...
function FeaturesCarousel() {
  ...
  /* Slide 2 — 6 Features */
  const SlideFeatures = () => (
    <div style={{ ...CARD, padding: mob ? "24px 20px" : "20px 44px", height: mob ? 260 : 280, maxHeight: mob ? 260 : 280, boxSizing:"border-box", display:"flex", alignItems:"center", overflow:"hidden" }}>
      <Wave/>
